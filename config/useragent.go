...
const EdgeUA = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36 Edg/145.0.0.0"

//const IE_UA = "Mozilla/5.0 (Windows NT 6.3; Trident/7.0; rv 11.0) like Gecko"

//var USERAGENT = IE_UA

const FireFoxUA = "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:147.0) Gecko/20100101 Firefox/147.0"
